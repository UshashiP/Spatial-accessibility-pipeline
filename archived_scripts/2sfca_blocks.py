...
# plot ICFs on the map
pri_df.plot(ax=ax, color='blue', markersize=7)

# set axis labels and title
ax.set_title('Gravity based Accessibility for Intermediate Care Facilities in DC', fontsize=16)
